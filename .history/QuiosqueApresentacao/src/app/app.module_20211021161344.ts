import { PedidoListComponent } from './../../../.history/QuiosqueApresentacao/src/app/pedido/pedido-list.component_20211021160724';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      {
        path: 'identificacao/:categoryId', component: IdentificacaoListComponent
      },
      {
