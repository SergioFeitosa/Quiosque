import { CardapioPrincipalComponent } from './../../../../.history/QuiosqueApresentacao/src/app/cardapioPrincipal/cardapio-principal.component_20211019200821';
...
@Injectable({
  providedIn: 'CardapioPrincipalComponent',
})
  ...
  constructor(public router: Router, private cardapioPrincipalComponent: CardapioPrincipalComponent)
{
  ...
  validarCodigo(): void {
    ...
    if (this.codigo > 0) {
      ...
      this.cardapioPrincipalComponent.updateButtonDisabled();
