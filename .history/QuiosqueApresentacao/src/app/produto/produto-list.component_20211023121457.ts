...
export class ProdutoListComponent implements OnInit {
  ...
  produtoPreco = this.produto.description;
  produtoTempoPreparacao = this.produto.description;
  produtoAvaliacao = this.produto.description;
  ...
  openPopup(produtoId: number): void {
    ...
    this.produtoPreco = this.produto.description;
    this.produtoTempoPreparacao = this.produto.description;
    this.produtoAvaliacao = this.produto.description;
