...
export class ProdutoListComponent implements OnInit {
  ...
  openPopup(produtoId: number): void {
    ...
    this.produto = this.produtoService.readById(produtoId).subscribe(produto => { this._produto = produto; });


    this._produto.name = this.produto.subscribe(produto => { this._produto = produto; });
