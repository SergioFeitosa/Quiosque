...
export class ProdutoListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.produtoService.read().subscribe(products => {
      ...
      console.log('produto-list ' + products);
    });

    this.filteredProdutos = this.products;
    console.log('produto-list dd' + this.filteredProdutos);
  }
  ...
  set filter(value: string) {
    ...
    this.products.filter((produto: Produto) => produto.name.toLocaleLowerCase().indexOf(this._filterBy.toLocaleLowerCase()) > -1);
  }
