...
export class CardapioPrincipalComponent implements OnInit {
  ...
  updateClassDisabled() {
    ...
    this.element1.setAttribute('enabled', 'false');
  ...
  updateClassEnabled() {
    this.buttonDisabled = false;
    console.log('passei enabled ' + this.buttonDisabled);
    ...
    this.element1.setAttribute('enabled', '');
    ...
    this.element8.setAttribute('disabled', 'false');
  }
