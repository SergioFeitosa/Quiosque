...
export class PedidoListComponent implements OnInit {
  ...
  entregaCreate(pedidoId: number): void {
    ...
    openPopup(pedidoId: number): void {
      ...
      // tslint:disable-next-line:no-unused-expression
      this.pedidoService.readById(produtoId).subscribe(product => {
    ...
    closePopup() {
      // tslint:disable-next-line:no-unused-expression
      this.pedidoService.readById(this.pedidoId).subscribe(pedido => {
        this.pedido = pedido;

        this.pedido.observacao = this.pedidoObservacao;
